#include "../include/VectorOfMatchingCharsBuilder.hpp"

VectorOfMatchingCharsBuilder::VectorOfMatchingCharsBuilder()
{
...
std::vector<std::vector<PossibleChar>> VectorOfMatchingCharsBuilder::findVectorOfVectorsOfMatchingChars(const std::vector<PossibleChar> &vectorOfPossibleCharsInScene)
{
    std::vector<std::vector<PossibleChar>> vectorOfVectorsOfMatchingChars;

    for (auto &possibleChar : vectorOfPossibleCharsInScene)
    {
        std::vector<PossibleChar> vectorOfMatchingChars = findVectorOfMatchingChars(possibleChar, vectorOfPossibleCharsInScene);
        ...
        for (auto &possChar : vectorOfPossibleCharsInScene)
        {
...
std::vector<PossibleChar> VectorOfMatchingCharsBuilder::findVectorOfMatchingChars(const PossibleChar &possibleChar, const std::vector<PossibleChar> &vectorOfChars)
{
